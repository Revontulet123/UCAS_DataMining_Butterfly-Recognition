# -*- coding: utf-8 -*-
"""
Created on Wed May 23 20:41:32 2018
...
if __name__ == '__main__':
    ...
    imgPath = 'D:\\Images\\JPEGImages'

    # 生成train.record文件
    output_path = 'D:\\Images\\data_train.record'
    csv_train_input = 'D:\\Images\\data_train-1.csv'
    main(csv_train_input, output_path, imgPath)

    # 生成验证文件 eval.record
    output_path = 'D:\\Images\\data_eval.record'
    csv_eval_input = 'D:\\Images\\data_eval-1.csv'
